...
$(document).on('click', '.btn-adduser', function() {
	...
	var zhiwei = $('input[name="zhiwu"]').val();
	...
	if (account.length == 0 || password.length == 0 || gonghao.length == 0 || name.length == 0 || zhiwei.length == 0 ||
		...
		if (result.success) {
			layer.open({
				...
				yes: function(index, layero) {
					...
					var zhiwei = $('input[name="edit-zhiwu"]').val();
